    ...
    public void sendFeedbackMail(String to, Long ID, String mailState, String replyContent) throws MessagingException {
        ...
        switch (mailState) {
            case "duplicateVarMail":
                content = "亲爱的用户：<br>" +
                        "您好！<br>" +
                        "错误原因：您的回信中可能出现了多次<b>成果类型、成果编号、审核结果</b>的字样。<br>" +
                        "解决方法：请仅在邮件中保留要求的内容，多余的内容请删除。<br>" +
                        "请使用标题为<b>请在教学系统中审核XX的论文成果，成果编号：XX</b>的邮件要求的回信格式。<br><br>" +
                        "本邮件由东华大学计算机学院教学系统自动发出，如有疑问，请联系<a href=\"mailto:rateAdmin@126.com?\">管理员</a>！<br><br>" +
                        replyContent;
                break;
            case "junkMail":
                content = "亲爱的用户：<br>" +
