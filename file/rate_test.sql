...
-- ----------------------------
BEGIN;
INSERT INTO `mail` (`mailAddress`, `password`) VALUES ('ratemail@126.com', 'IOLMDKJXAQJQUAMN');
COMMIT;
...
INSERT INTO `menu` (`id`, `url`, `path`, `component`, `name`, `iconCls`, `keepAlive`, `requireAuth`, `parentId`, `enabled`) VALUES (80, '/salary/search/**', '/secretary/actGroup', 'ActList', '活动列表', NULL, NULL, 1, 82, 1);
...
INSERT INTO `menu` (`id`, `url`, `path`, `component`, `name`, `iconCls`, `keepAlive`, `requireAuth`, `parentId`, `enabled`) VALUES (85, NULL, '/secretary/SecManage', 'SecManage', '秘书管理', NULL, NULL, 1, 36, 1);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=334 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `menu_role` (`id`, `mid`, `rid`) VALUES (331, 83, 1);
INSERT INTO `menu_role` (`id`, `mid`, `rid`) VALUES (332, 84, 1);
INSERT INTO `menu_role` (`id`, `mid`, `rid`) VALUES (333, 85, 4);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6118 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of paper
-- ----------------------------
BEGIN;
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6095, 2086, '1', '2022', 1, '卢三', 1, 1, 12, NULL, 1, '1-2', 'tea_pass', '');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6096, 2086, '2', '2022', 1, '卢三;李四', 1, 2, 12, NULL, 3, '1-20', 'adm_pass', '');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6097, 2086, '3', '2022', 2, '卢三', 1, 1, 12, NULL, 2, '1-3', 'commit', 'F:\\Rate\\upload/Pruning_Survey_MLA21.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6098, 2086, '4', '2022', 4, '卢三', 1, 1, 12, NULL, 2, '2-3', 'tea_reject', '');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6099, 2086, '5', '2022', 2, '卢三;zz', 1, 2, 12, NULL, 5, '2-3', 'adm_reject', '/Users/luyiru/Desktop/研究生网站开发/Rate/work2/rate/upload/测试.docx');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6100, 2086, '6', '2022', 2, '卢三;', 1, 2, 12, NULL, 4, '2-22', 'adm_pass', '/Users/luyiru/Desktop/研究生网站开发/Rate/work2/rate/upload/知识产权作业.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6103, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/6289e6dccfb7a.jpg');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6104, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6106, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6107, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6108, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6109, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6110, 2086, '撒大苏打', '2023', 2, '卢三', 1, 1, 12, NULL, 60, '1-121', 'commit', 'F:\\Rate\\upload/shufflenet.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6111, 2086, '阿斯顿阿萨v的', '2023', 1, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/2201-2222738-张亚魁.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6112, 2086, '阿斯顿阿萨v的', '2023', 1, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/2201-2222738-张亚魁.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6113, 2086, '阿斯顿阿萨v的', '2023', 1, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/2201-2222738-张亚魁.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6114, 2086, '阿斯顿阿萨v的', '2023', 1, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/2201-2222738-张亚魁.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6115, 2086, '阿斯顿阿萨v的', '2023', 1, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/2201-2222738-张亚魁.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6116, 2086, '发电公司给', '2023', 2, '卢三', 1, 1, 12, NULL, 3, '1-121', 'commit', 'F:\\Rate\\upload/L181310122-段煜峰.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6117, 2086, '某2分论文', '2023', 1, '卢三', 1, 1, 2, NULL, 64, '1-2', 'commit', '/Users/gongrunze/Rate/upload/个人信息.docx');
COMMIT;
...
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (216, 'student', 2086, '卢三', 6116, '发电公司给', 3, '《中共党史研究》', '2023-03-05 12:49:00', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (217, 'student', 2086, '卢三', 6117, '某2分论文', 64, '某2分论文2', '2023-03-14 18:33:41', '提交论文', 'commit', '');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=746 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of papercomment
-- ----------------------------
BEGIN;
INSERT INTO `papercomment` (`ID`, `thesisID`, `dateStu`, `dateTea`, `preSum`, `nextPlan`, `tutorComment`, `num`) VALUES (745, 1, '2023-03-08', NULL, '岁的法国地方是否', '吧v你发给更换', '', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `properties` (`host`, `username`, `password`, `id`, `sendHost`) VALUES ('imap.126.com', 'ratemail@126.com', 'IOLMDKJXAQJQUAMN', 1, 'smtp.126.com');
INSERT INTO `properties` (`host`, `username`, `password`, `id`, `sendHost`) VALUES ('imap.163.com', '2222738@mail.dhu.edu.cn', 'efYRe5Nf414VTAz4', 2, 'smtp.163.com');
INSERT INTO `properties` (`host`, `username`, `password`, `id`, `sendHost`) VALUES ('imap.163.com', 'yakuizhang1111@163.com', 'MWCQFMLCWCNNPIOF', 3, 'smtp.163.com');
INSERT INTO `properties` (`host`, `username`, `password`, `id`, `sendHost`) VALUES ('imap.163.com', 'yakuizhang1111@163.com', 'MWCQFMLCWCNNPIOF', 4, 'smtp.163.com');
INSERT INTO `properties` (`host`, `username`, `password`, `id`, `sendHost`) VALUES ('imap.126.com', 'sw21706091085@126.com', 'CKJRUHJRNBHADFIJ', 5, 'smtp.126.com');
COMMIT;
...
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (18, '《International Conference on Data Engineering(ICDE)》', NULL, NULL, NULL, NULL, 5, 2001);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (59, '《中共党史研究》', '你的刊物简称', '你的刊物出版社', '你的刊物网址', '收录级别1;级别2;（请用分号隔开）', 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (60, 'test2', 'sad', 'sd', 'dsd', 'dsa', 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (61, 'test3', 'sd', 'sdfsfd', 'fddf', 'saef', 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (62, 'test4', 'sad', 'dsa', 'daw', 'asd', 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (63, 'test5', 'sd', 'dsa', 'sd', 'sd', 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (64, '某2分期刊2', '2', '2', '2', '2', 24, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (65, '某2分期刊1', '2', '2', '2', '2', 24, 2023);
COMMIT;
...
INSERT INTO `student` (`ID`, `name`, `institutionID`, `studentnumber`, `IDNumber`, `telephone`, `email`, `username`, `password`, `year`, `deleteflag`, `tutorID`, `role`, `score`) VALUES (2086, '卢三', 1, NULL, '310111111111111111', '13812341231', '123@dhu.edu.cn', 'student', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 0, 1003, '11', 0);
...
-- ----------------------------
BEGIN;
INSERT INTO `teacher` (`ID`, `institutionID`, `name`, `jobnumber`, `sex`, `department`, `IDNumber`, `phone`, `email`, `username`, `password`, `deleteflag`, `role`) VALUES (1003, NULL, '张三', '1310092', '女', '计算机学院', '310110100000000022', '13800000011', '3311980798@qq.com', 'teazhang', '$2a$10$uHDCc/t1wijNiOcZZucpbecsV0O61/iKk8mo95w5u43uek1Grz3za', 0, '8');
...
CREATE TABLE `totalitem` (
  `ID` int NOT NULL,
  `activityID` int DEFAULT NULL,
  `infoSumIDs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `scoreSumIDs` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
-- ----------------------------
BEGIN;
INSERT INTO `totalitem` (`ID`, `activityID`, `infoSumIDs`, `scoreSumIDs`) VALUES (1, 26, '53,54', '92,93');
COMMIT;
