...
CREATE TABLE `activities` (
  ...
  `scoreItemCount` int(11) DEFAULT NULL,
  `score` double(10,2) unsigned DEFAULT NULL,
  `groupCount` int(10) unsigned DEFAULT NULL,
  `expertCount` int(10) unsigned DEFAULT NULL,
  `participantCount` int(10) unsigned DEFAULT NULL,
  `comment` varchar(2000) DEFAULT NULL,
  `deleteFlag` tinyint(3) unsigned NOT NULL,
...
CREATE TABLE `admin` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `institutionID` int(11) NOT NULL COMMENT '外键',
...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES (1, 1, 'wow', 'admin', '$2a$10$/VauH0rmJH0BlAwZhTzkv.ELdAQP8sVrghoqoNrQ0s8mEwUjjiSOa', '135266135', '123456@126.COM', NULL, '6', 1);
INSERT INTO `admin` VALUES (2, 1, 'wow1', 'admin1', '$2a$10$CQ0EgGSxJhnQ/NLSNUsuWeIPLaLeyFdLh6NgLCVJpEjPRdA64CRXq', '18568887789', '555@dhu.edu.cn', '123', '1', 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `award` VALUES (1, '国家技术发明奖', 13);
...
CREATE TABLE `groups` (
  ...
  `activityID` int(11) DEFAULT NULL,
  `name` varchar(60) DEFAULT NULL,
  `expertCount` int(11) DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `indicator` VALUES (1, '1类（12分）', NULL, '1', 12, NULL);
...
INSERT INTO `indicator` VALUES (10, '2类（6分）', NULL, '2', 6, NULL);
...
INSERT INTO `indicator` VALUES (15, '1.4 决策咨询成果', '决策咨询成果', '1.4', 12, 1);
...
CREATE TABLE `infoitem` (
  ...
  `byParticipant` tinyint(4) NOT NULL,
  `display` tinyint(4) NOT NULL COMMENT '是否显示在评分表中',
  PRIMARY KEY (`ID`) USING BTREE,
...
INSERT INTO `infoitem` VALUES (54, 26, '上机练习', ',', '500', 1, 1);
INSERT INTO `infoitem` VALUES (55, 26, '本科成绩单', 'pdf,jpg,zip,', '500M', 1, 0);
COMMIT;
...
CREATE TABLE `infos` (
  ...
  `infoItemID` int(11) DEFAULT NULL,
...
INSERT INTO `infos` VALUES (506, 26, 139, 54, '90/100');
...
CREATE TABLE `institution` (
  ...
  `activityCount` int(11) DEFAULT NULL COMMENT '单位总计活动数',
  `uplimit` int(11) DEFAULT NULL COMMENT '单位活动数上限',
...
CREATE TABLE `logs` (
  ...
  `operator` int(11) DEFAULT NULL COMMENT '操作内容',
...
INSERT INTO `menu` VALUES (43, '/', '/home', 'Home', '成果申报', 'fa-fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (44, '/', '/home', 'Home', '成果列表', 'fa-fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (45, '/salary/search/**', '/UserInfo', 'UserInfo', '个人资料', NULL, NULL, 1, 42, 1);
INSERT INTO `menu` VALUES (46, '/salary/search/**', '/student/Paper', 'Paper', '论文', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (47, '/salary/search/**', '/student/Patent', 'Patent', '专利', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (48, '/salary/search/**', '/student/ResearchAward', 'ResearchAward', '科研获奖', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (49, '/salary/search/**', '/student/Product', 'Product', '科研项目', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (50, '/salary/search/**', '/student/AcademicMonograph', 'AcademicMonograph', '学术专著和教材', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (51, '/salary/search/**', '/student/ResearchProject', 'ResearchProject', '制造或设计的产品', NULL, NULL, 1, 43, 1);
INSERT INTO `menu` VALUES (52, '/salary/search/**', '/student/Achievements', 'Achievements', '成果列表', NULL, NULL, 1, 44, 1);
INSERT INTO `menu` VALUES (53, '/', '/home', 'Home', '待审核', 'fa fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (54, '/', '/home', 'Home', '学生成果', 'fa fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (55, '/', '/home', 'SalSearch', '所有成果', 'fa fa-windows', NULL, 1, 1, 1);
...
INSERT INTO `menu` VALUES (67, '/', '/admin/SalExamine', 'Examine', '待审核', NULL, NULL, 1, 66, 1);
INSERT INTO `menu` VALUES (68, '/', '/admin/SalAchievements', 'Achievements', '所有成果', NULL, NULL, 1, 66, 1);
COMMIT;
...
INSERT INTO `menu_role` VALUES (286, 9, 3);
INSERT INTO `menu_role` VALUES (289, 37, 1);
INSERT INTO `menu_role` VALUES (290, 38, 1);
INSERT INTO `menu_role` VALUES (291, 40, 1);
INSERT INTO `menu_role` VALUES (292, 45, 7);
INSERT INTO `menu_role` VALUES (293, 46, 7);
INSERT INTO `menu_role` VALUES (294, 47, 7);
INSERT INTO `menu_role` VALUES (295, 48, 7);
INSERT INTO `menu_role` VALUES (296, 49, 7);
INSERT INTO `menu_role` VALUES (297, 50, 7);
INSERT INTO `menu_role` VALUES (298, 51, 7);
INSERT INTO `menu_role` VALUES (299, 52, 7);
INSERT INTO `menu_role` VALUES (300, 56, 8);
INSERT INTO `menu_role` VALUES (301, 57, 8);
INSERT INTO `menu_role` VALUES (302, 58, 8);
INSERT INTO `menu_role` VALUES (303, 59, 8);
INSERT INTO `menu_role` VALUES (304, 60, 8);
INSERT INTO `menu_role` VALUES (305, 61, 8);
INSERT INTO `menu_role` VALUES (306, 62, 8);
INSERT INTO `menu_role` VALUES (307, 63, 8);
INSERT INTO `menu_role` VALUES (308, 45, 8);
...
CREATE TABLE `paper` (
  ...
  `month` int(11) DEFAULT NULL COMMENT '出版月',
  ...
  `publicationID` int(11) DEFAULT NULL COMMENT '刊物id',
...
) ENGINE=InnoDB AUTO_INCREMENT=6068 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of paper
-- ----------------------------
BEGIN;
INSERT INTO `paper` VALUES (6032, 2086, '机器学习sjid', '2021', 3, '张三', 1, 1, 12, 1, '12-131', 'tea_pass', '东华.pdf');
INSERT INTO `paper` VALUES (6033, 2086, '图像处理123', '2020', 7, '张三', 1, 1, 12, 2, '23-56', 'tea_pass', '东华.pdf');
INSERT INTO `paper` VALUES (6035, 2086, '深度学习2234', '2020', 7, '张三', 1, 1, 12, 2, '33-45', 'tea_pass', NULL);
INSERT INTO `paper` VALUES (6036, 2082, 'zhang论文1', '2022', 1, '张狗', 1, 1, 12, 3, '34-56', 'tea_pass', NULL);
INSERT INTO `paper` VALUES (6037, 2086, '性能测试图像1233', '2022', 6, '张三', 1, 1, 12, 3, '22-34', 'tea_pass', NULL);
INSERT INTO `paper` VALUES (6038, 2082, '文字识别111', '2020', 4, '张狗', 1, 1, 12, 2, '11-34', 'commit', '东华.pdf');
INSERT INTO `paper` VALUES (6039, 2082, '第三次深度学习', '2022', 1, '张狗', 1, 1, 12, 3, '33-56', 'commit', NULL);
INSERT INTO `paper` VALUES (6041, 2082, '文字识别1111', '2021', 2, '张狗', 1, 1, 12, 1, '22-66', 'commit', NULL);
INSERT INTO `paper` VALUES (6042, 2083, '211111', '2021', 7, '张狗1', 1, 1, 12, 2, '22-45', 'tea_pass', NULL);
INSERT INTO `paper` VALUES (6043, 2083, '2222张狗1', '2020', 2, '张狗1', 1, 1, 12, 3, '22-45', 'commit', NULL);
INSERT INTO `paper` VALUES (6044, 2083, '3333张狗1', '2019', 4, '张狗1', 1, 1, 12, 1, '88-90', 'tea_reject', NULL);
INSERT INTO `paper` VALUES (6047, 2083, 'hhhh11张狗1', '2020', 2, '张狗1', 1, 1, 12, 1, '23-55', 'adm_pss', NULL);
INSERT INTO `paper` VALUES (6061, 2086, '33333', '2021', 1, '张三；李四；王武', 1, 3, 12, 1, '11-45', 'adm_pss', 'IMG_5767.JPG');
INSERT INTO `paper` VALUES (6064, 2086, '星期一test1', '2020', 1, '张三;李四', 1, 2, 12, 2, '23-44', 'commit', NULL);
INSERT INTO `paper` VALUES (6067, 2086, '晚上test2', '2020', 2, '张老师；张三；李四', 1, 3, 12, 5, '23-44', 'commit', NULL);
COMMIT;
...
CREATE TABLE `paper_oper` (
  ...
  `paperID` int(11) DEFAULT NULL COMMENT '论文ID',
  `paperName` varchar(256) DEFAULT NULL COMMENT '论文名称',
  `pubID` int(11) DEFAULT NULL COMMENT '出版物ID',
...
-- ----------------------------
BEGIN;
INSERT INTO `paper_oper` VALUES (23, 'student', 2086, '张三', 6032, '机器学习sjid', 4004, '中国社会生活', '2022-09-09 12:35:31', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (24, 'student', 2086, '张三', 6033, '图像处理123', 4005, '计算机社会科学', '2022-09-09 17:52:15', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (25, 'student', 2086, '张三', 6035, '深度学习2234', 4004, '中国社会生活', '2022-09-09 18:03:31', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (26, 'teacher', 1043, '刘哈哈', 6035, '深度学习2234', 4004, '中国社会生活', '2022-09-09 18:05:11', '审核驳回', 'tea_reject', '字数少');
INSERT INTO `paper_oper` VALUES (27, 'student', 2082, '张狗', 6036, 'zhang论文1', 4001, '中国社会科学', '2022-09-09 19:10:50', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (28, 'student', 2086, '张三', 6037, '性能测试图像1233', 3, '《中共党史研究》', '2022-09-13 16:10:50', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (29, 'teacher', 1043, '刘哈哈', 6037, '性能测试图像1233', NULL, '', '2022-09-13 16:22:35', '审核驳回', 'tea_reject', 'sjiuadhn');
INSERT INTO `paper_oper` VALUES (30, 'teacher', 1043, '刘哈哈', 6032, '机器学习sjid', NULL, '', '2022-09-14 19:09:40', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (31, 'student', 2082, '张狗', 6038, '文字识别111', 2, 'International Conference on Data Engineering(ICDE)', '2022-09-21 20:40:24', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (32, 'student', 2082, '张狗', 6039, '第三次深度学习', 3, '《中共党史研究》', '2022-09-21 21:00:20', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (34, 'student', 2082, '张狗', 6041, '文字识别1111', 1, '《中国社会科学》', '2022-09-22 09:16:17', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (35, 'student', 2083, '张狗1', 6042, '211111', 2, 'International Conference on Data Engineering(ICDE)', '2022-09-23 10:21:17', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (36, 'student', 2083, '张狗1', 6043, '2222张狗1', 3, '《中共党史研究》', '2022-09-23 10:23:35', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (37, 'student', 2083, '张狗1', 6044, '3333张狗1', 1, '《中国社会科学》', '2022-09-23 10:34:57', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (40, 'student', 2083, '张狗1', 6047, 'hhhh11张狗1', 1, '《中国社会科学》', '2022-09-23 11:26:02', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (41, 'teacher', 1043, '刘哈哈', 6047, 'hhhh11张狗1', NULL, '', '2022-09-23 17:02:06', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (43, 'teacher', 1043, '刘哈哈', 6033, '图像处理123', NULL, '', '2022-10-31 16:17:44', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (44, 'student', 2086, '张三', 6048, '自然语言处理ssss', 1, '《中国社会科学》', '2022-10-31 16:21:09', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (45, 'teacher', 1043, '刘哈哈', 6035, '深度学习2234', NULL, '', '2022-10-31 16:25:37', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (46, 'student', 2086, '张三', 6037, '性能测试图像1233', 6037, '《中共党史研究》', '2022-11-02 17:21:10', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (47, 'teacher', 1043, '刘哈哈', 6037, '性能测试图像1233', NULL, '', '2022-11-02 17:36:49', '审核驳回', 'tea_reject', '不同意');
INSERT INTO `paper_oper` VALUES (51, 'teacher', 1043, '刘哈哈', 6037, '性能测试图像1233', NULL, '', '2022-11-09 20:20:16', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (62, 'student', 2086, '张三', 6061, '33333', 2, 'International Conference on Data Engineering(ICDE)', '2022-11-10 22:50:09', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (63, 'teacher', 1043, '刘哈哈', 6061, '33333', NULL, '', '2022-11-13 19:03:19', '审核驳回', 'tea_reject', '');
INSERT INTO `paper_oper` VALUES (64, 'teacher', 1043, '刘哈哈', 6044, '3333张狗1', NULL, '', '2022-11-13 19:17:20', '审核驳回', 'tea_reject', '字数不够');
INSERT INTO `paper_oper` VALUES (65, 'teacher', 1043, '刘哈哈', 6048, '自然语言处理ssss', NULL, '', '2022-11-13 19:32:37', '审核驳回', 'tea_reject', '内容杂乱无章');
INSERT INTO `paper_oper` VALUES (66, 'teacher', 1043, '刘哈哈', 6061, '33333', NULL, '', '2022-11-13 19:32:51', '审核通过', 'tea_pass', '内容杂乱无章');
INSERT INTO `paper_oper` VALUES (67, 'teacher', 1043, '刘哈哈', 6042, '211111', NULL, '', '2022-11-14 16:30:31', '审核通过', 'tea_pass', '');
INSERT INTO `paper_oper` VALUES (68, 'teacher', 1043, '刘哈哈', 6036, 'zhang论文1', NULL, '', '2022-11-14 16:30:55', '审核驳回', 'tea_reject', '条理混乱 不清晰');
INSERT INTO `paper_oper` VALUES (69, 'teacher', 1043, '刘哈哈', 6036, 'zhang论文1', NULL, '', '2022-11-14 16:31:13', '审核通过', 'tea_pass', '条理混乱 不清晰');
INSERT INTO `paper_oper` VALUES (72, 'student', 2086, '张三', 6064, '星期一test1', 1, '《中国社会科学》', '2022-11-14 16:51:50', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (73, 'teacher', 1043, '刘哈哈', 6064, '星期一test1', NULL, '', '2022-11-14 16:57:51', '审核驳回', 'tea_reject', 'jiaudakdnaihds');
INSERT INTO `paper_oper` VALUES (76, 'student', 2086, '张三', 6067, '晚上test2', 5, '11', '2022-11-14 20:07:57', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (77, 'student', 2086, '张三', 6068, '星期一晚上第二次test', 6, '21', '2022-11-14 21:40:24', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (78, 'teacher', 1043, '刘哈哈', 6064, '星期一test1', NULL, '', '2022-11-15 21:03:56', '审核驳回', 'tea_reject', 'ssjjjkk');
INSERT INTO `paper_oper` VALUES (79, 'teacher', 2, 'wow1', NULL, '', NULL, NULL, '2022-11-22 16:29:18', '审核驳回', 'adm_pss', '');
INSERT INTO `paper_oper` VALUES (80, 'teacher', 2, 'wow1', NULL, '', NULL, NULL, '2022-11-22 16:29:18', '审核驳回', 'adm_pss', '');
COMMIT;
...
INSERT INTO `participants` VALUES (26, 26, 2092, '181310007', NULL, NULL, NULL, NULL, 1, 78.00, 145);
...
-- ----------------------------
BEGIN;
INSERT INTO `publication` VALUES (1, '《中国社会科学》', '简称1', '出版社1', '网址1', '级别1', 4);
INSERT INTO `publication` VALUES (2, 'International Conference on Data Engineering(ICDE)', NULL, NULL, NULL, NULL, 5);
INSERT INTO `publication` VALUES (3, '《中共党史研究》', '简称2', '出版社2', '网址2', '级别2', 4);
INSERT INTO `publication` VALUES (5, '12', '12', '13', '14', '15', 4);
INSERT INTO `publication` VALUES (6, '21', '22', '23', '24', '25', 4);
INSERT INTO `publication` VALUES (7, '31', '32', '33', '34', '35', 4);
INSERT INTO `publication` VALUES (8, '2', '2', '', '', '', 4);
COMMIT;
...
INSERT INTO `role` VALUES (7, 'ROLE_student', '学生');
INSERT INTO `role` VALUES (8, 'ROLE_teacher', '教师');
COMMIT;
...
CREATE TABLE `scores` (
  ...
  `activityID` int(11) DEFAULT NULL,
  `participantID` int(11) DEFAULT NULL,
  `scoreItemID` int(11) DEFAULT NULL,
  `score` double(10,2) DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=738 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `student` (
  ...
  `institutionID` int(11) DEFAULT NULL COMMENT '外键',
...
) ENGINE=InnoDB AUTO_INCREMENT=2097 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of student
-- ----------------------------
BEGIN;
INSERT INTO `student` VALUES (2071, '陈锦豪', 21, NULL, '102551210004479', '17376569429', 'jinhaochan365@163.com', '102551210004479', '$2a$10$/VauH0rmJH0BlAwZhTzkv.ELdAQP8sVrghoqoNrQ0s8mEwUjjiSOa', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2072, '李烨', 21, NULL, '102551210002476', '18834165165', '1023568236@qq.com', '102551210002476', '$2a$10$DYbdcC5AeaJnil3wKR15UuUtFql7z94AWSmUKTmYvK0qdE7hGTdrS', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2073, '王双红', 21, NULL, '102551210008659', '17754442425', '1394756525@qq.com', '102551210008659', '$2a$10$TjK9t0/JSOhcd7.VnN7XGerj5cR75KDm/sRiCOxXukHs40OYpuKBS', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2074, '史航', 21, NULL, '102551210002424', '15532175718', '1031576719@qq.com', '102551210002424', '$2a$10$YrVVNooFp4lK/49wdEBFy.fl/iqkvwn8kMCFWnqAyS7MCpd.WUUDi', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2075, '陈奎佑', 21, NULL, '102551210003963', '18717967816', 'chenkuiyou95@163.com', '102551210003963', '$2a$10$zbX7K2JyZQX5sj2Q5bXMlOgRTrvQL3uhIypyrLrLMdoFtSilkDa2y', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2076, '朱冰竹', 21, NULL, '102551210008999', '17621666942', '17621666942@163.com', '102551210008999', '$2a$10$LI89BhBJDOcLbPLlKsLLY.Di.9j7wns/ooG4pvZLIgQ7KO7xuqnwK', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2077, '杨彬', 21, NULL, '102551210000145', '18621333050', '2211265445@qq.com', '102551210000145', '$2a$10$SUjg/Gc2iH22243QSA1Sf.i9dTL7wC8UPQPI5nyEcwcMrLPowGgFu', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2078, '赵宇成', 21, NULL, '102551210009175', '15727466250', '1464330884@qq.com', '102551210009175', '$2a$10$3wOHTbDP7ou9TD.se29o.u3YHHzyhg6JCj.NeCX83SKHdUMCvt/ry', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2079, '於柏安', 21, NULL, '102551210004782', '18892626454', '837720757@qq.com', '102551210004782', '$2a$10$Kw0mg5aoI8pG.ka02IDQduGb/7mVFbjVItnskgl1awANPtkBMf/mu', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2080, '王启源', 21, NULL, '102551210008226', '15690866680', '1831977837@qq.com', '102551210008226', '$2a$10$oEZixbDNYxZ7.ow7/KhQZentWCmIbR3tDWjAH/wfOKEkni83cWJXe', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2081, '张三3', NULL, NULL, '181310000', '13812341234', '123@dhu.edu.cn', 'zhangsan', '$2a$10$RkUhuabY5KPb7.K9oGeDbOnd8bNYtS2p8SFiN0atlkrAkHMsRMQtG', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2082, '张狗', NULL, NULL, '181310001', '12812341234', '123@dhu.edu.cn', 'zhangdog', '$2a$10$RkUhuabY5KPb7.K9oGeDbOnd8bNYtS2p8SFiN0atlkrAkHMsRMQtG', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2083, '张狗1', NULL, NULL, '181310002', '12812341554', '123@dhu.edu.cn', 'zhangdog1', '$2a$10$RkUhuabY5KPb7.K9oGeDbOnd8bNYtS2p8SFiN0atlkrAkHMsRMQtG', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2084, '张三2', NULL, NULL, '310111111111111000', '13812341204', '123@dhu.edu.cn', '第一组', '$2a$10$KhfsQjXcxefZhGsrASFYe.kFUiyCNivVMkTSYAxEkmMzT6521VLTi', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2085, '张三测试', NULL, NULL, '310111111111661111', '13812341244', '123@dhu.edu.cn', 'zhangtestsan', '$2a$10$Xk4SCIJPnJ.RHN7y7Il0BOI5/qQI5/UnYgYuDAmQJKK4csHhfHfPy', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2086, '张三', NULL, NULL, '310111111111111111', '13812341231', '123@dhu.edu.cn', 'student', '$2a$10$uHDCc/t1wijNiOcZZucpbecsV0O61/iKk8mo95w5u43uek1Grz3za', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2087, '钟平灵', NULL, NULL, '310111111111111112', '13812341232', '124@dhu.edu.cn', '181310002', '$2a$10$XGhQ5ESI1h1/U3Mbe3pPCOPtwX9L8u2MsLKuST8H9Th.BP4Qcoane', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2088, '陈俊驰', NULL, NULL, '310111111111111113', '13812341233', '125@dhu.edu.cn', '181310003', '$2a$10$Ktx07OtruoNd1P2LW6/75.O7HS7j5IT86AJzHiA59o7uuZZf.LeA2', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2089, '张冷丹', NULL, NULL, '310111111111111114', '13812341234', '126@dhu.edu.cn', '181310004', '$2a$10$hA4xnuVJIOoAKd5XAxorS.qLpGSHUiOOYZX1qKk9AYHYFyg32Ymby', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2090, '张良策', NULL, NULL, '310111111111111115', '13812341235', '127@dhu.edu.cn', '181310005', '$2a$10$JPi5BEL/0N5e4KkpH3aG7ORmM.l4e8/RE2H95IoeJJd68wH3unQ7u', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2091, '王若琳', NULL, NULL, '310111111111111116', '13812341236', '128@dhu.edu.cn', '181310006', '$2a$10$.SNSk9ilnxlDfo33isnvtOppto9z7jKtE2v0.tKRLHEJYYR3l5dOG', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2092, '陈嘉菲', NULL, NULL, '310111111111111117', '13812341237', '129@dhu.edu.cn', '181310007', '$2a$10$mh8I02.vy40xuOCqnNxWNOzKpjiSYDKpDZd3S0PKzOZgdJvY9gLAi', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2093, '钟安卉', NULL, NULL, '310111111111111118', '13812341238', '130@dhu.edu.cn', '181310008', '$2a$10$/LV3EbAdNLz61GikPkIqe.ExN5F3UVHHdW3Y0.yDI5Lquc/qfscTS', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2094, '王青芙', NULL, NULL, '310111111111111119', '13812341239', '131@dhu.edu.cn', '181310009', '$2a$10$MSARsU7QH6uvFDgUfuWcSO1lsmE/mqGJ1MLlccmNkXeFAQMdm.yeO', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2095, '测试序号', 21, NULL, '310111111111121000', '10012341234', '123@dhu.edu.cn', '1191310000', '$2a$10$zYoet0Y0hIt65XHVWy6svewahcA5inu8CfcxCYRh9ukUK4Ylxtat.', NULL, 0, 1003, 7);
INSERT INTO `student` VALUES (2096, '测试分组', NULL, NULL, '310111111111111222', NULL, NULL, '1991310000', '$2a$10$CGlijEQCIwiSWg2bn26l6OmISrugSqQEoxqNgIE5LvJX5iYSlz3Oi', NULL, 0, 1003, 7);
COMMIT;
...
INSERT INTO `teacher` VALUES (1033, 21, '1', '1', '女', '1', '1', '1', '1', '1', '$2a$10$xwQWCUx8tIIrPKytfDvyoe4u5GcgOB6l2DqPMICcHHzHYmKS45XD.', 0, '3');
...
INSERT INTO `teacher` VALUES (1041, 1, '王曦芸', '131008', '女', '计算机学院', '310110100000000008', '13800000008', '008@dhu.edu.cn', '131008', '$2a$10$l3UrEu2AaW3GRLX9nHQt2O9TK7H0s/8okQhF9PuCydFaAf74hCe7O', 0, '3');
INSERT INTO `teacher` VALUES (1042, NULL, '陈宏大', '131009', '男', '计算机学院', '310110100000000009', '13800000009', '009@dhu.edu.cn', '131009', '$2a$10$yQVeQRjdav3FzRoG4SGnTu5BbRlVbJdr1YPqDEKKEij/xD/5Mp19m', 0, '3');
INSERT INTO `teacher` VALUES (1043, NULL, '刘哈哈', '131025', '女', '计算机学院', '310110100000000010', '13800000010', '010@dhu.edu.cn', 'teacher', '$2a$10$uHDCc/t1wijNiOcZZucpbecsV0O61/iKk8mo95w5u43uek1Grz3za', 0, '8');
COMMIT;
