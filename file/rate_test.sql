...
CREATE TABLE `activities` (
  ...
  `status` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'open',
...
INSERT INTO `activities` (`ID`, `name`, `startDate`, `scoreItemCount`, `score`, `groupCount`, `expertCount`, `participantCount`, `comment`, `deleteFlag`, `institutionID`, `status`) VALUES (26, '2022年D大学计算机学院硕士研究生综合面试', '2022-03-30 00:00:00', 3, 100.00, 2, 12, 9, '2022年111', 0, 1, 'open');
...
INSERT INTO `activities` (`ID`, `name`, `startDate`, `scoreItemCount`, `score`, `groupCount`, `expertCount`, `participantCount`, `comment`, `deleteFlag`, `institutionID`, `status`) VALUES (29, '2023年毕业设计', '2023-02-28 00:00:00', 0, 0.00, 0, 0, 0, '活动备注example：关于xxx的活动', 0, 1, 'open');
COMMIT;
...
CREATE TABLE `admin` (
  ...
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '邮箱地址',
  `comment` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
  `role` varchar(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '角色',
...
CREATE TABLE `awardresult` (
  ...
  `awardname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `year` int DEFAULT NULL,
  `member` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `bookresult` (
  ...
  `place` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `indicater` (
  ...
  `order` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `indicator` (
  ...
  `name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `type` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `order` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `score` int DEFAULT NULL,
  `father` int DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `father` (`father`) USING BTREE,
...
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (23, '5类', NULL, '4', 2, NULL);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (24, '论文', '论文', '4.1', 2, 23);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (25, '《东华大学科技论文认定办法》D类', '论文', '4.1.1', 2, 24);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (26, '《东华大学哲学社会科学成果认定办法》D类', '论文', '4.1.2', 2, 24);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (27, '科技奖', '科技奖', '4.2', 2, 23);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (28, '国家科技奖', '科技奖', '4.2.1', 2, 27);
INSERT INTO `indicator` (`ID`, `name`, `type`, `order`, `score`, `father`) VALUES (29, '省部科技奖', '科技奖', '4.2.2', 2, 27);
COMMIT;
...
CREATE TABLE `infoitem` (
  ...
  `activityID` int DEFAULT NULL,
  `name` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `contentType` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '值为textbox, textarea, image，分别表示单行文本、多行文本、图片\r\n\r\n',
  `sizelimit` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `institution` (
  ...
  `company` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '单位名称',
  `activityCount` int DEFAULT NULL COMMENT '单位总计活动数',
  `uplimit` int DEFAULT NULL COMMENT '单位活动数上限',
  `comment` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
...
-- ----------------------------
BEGIN;
INSERT INTO `institution` (`id`, `company`, `activityCount`, `uplimit`, `comment`, `deleteFlag`) VALUES (1, 'D大学计算机学院', 6, 50, 'D大学计算机学院', 0);
...
CREATE TABLE `logs` (
  ...
  `content` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (272, '2023-02-28 14:41:13', 1, '分组', '删除失败');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (273, '2023-02-28 14:46:21', 1, '信息项', '更新成功');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (274, '2023-02-28 14:46:24', 1, '信息项', '更新成功');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (275, '2023-02-28 14:46:25', 1, '信息项', '更新成功');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (276, '2023-02-28 14:46:27', 1, '信息项', '更新成功');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (277, '2023-02-28 17:28:05', 1, '活动', '添加成功');
INSERT INTO `logs` (`id`, `addDate`, `operator`, `category`, `content`) VALUES (278, '2023-02-28 20:17:58', 1, '分组', '删除失败');
COMMIT;
...
CREATE TABLE `menu` (
  `id` int NOT NULL AUTO_INCREMENT,
  `url` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `path` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `component` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `name` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `iconCls` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `menu` (`id`, `url`, `path`, `component`, `name`, `iconCls`, `keepAlive`, `requireAuth`, `parentId`, `enabled`) VALUES (77, '/salary/search/**', '/ActivitM/subActivity', 'SalSubActivity', '子活动管理', NULL, NULL, 1, 36, 1);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=328 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `menu_role` (`id`, `mid`, `rid`) VALUES (326, 71, 10);
...
CREATE TABLE `paper` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '论文题目',
  `year` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '出版年',
  `month` int DEFAULT NULL COMMENT '出版月',
  `author` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '作者列表',
  `rank` int DEFAULT NULL COMMENT '排名',
  `total` int DEFAULT NULL COMMENT '总人数',
  `point` int DEFAULT NULL COMMENT '积分',
  `no_score` int DEFAULT NULL COMMENT '判断2分期刊是否有效',
  `publicationID` int DEFAULT NULL COMMENT '刊物id',
  `pubPage` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '页码',
  `state` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'commit' COMMENT '状态',
...
) ENGINE=InnoDB AUTO_INCREMENT=6115 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of paper
-- ----------------------------
BEGIN;
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6111, 2086, '论文1', '2023', 1, '卢三', 1, 1, 12, NULL, 18, '1-2', 'commit', '/Users/gongrunze/Rate/upload/个人信息表.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6112, 2086, '论文2', '2023', 1, '卢三', 1, 1, 6, NULL, 77, '1-2', 'commit', '/Users/gongrunze/Rate/upload/个人信息表.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6113, 2086, 'test2', '2023', 1, '卢三', 1, 1, 2, 0, 72, '1-2', 'adm_pass', '/Users/gongrunze/Rate/upload/个人信息表.pdf');
INSERT INTO `paper` (`ID`, `studentID`, `name`, `year`, `month`, `author`, `rank`, `total`, `point`, `no_score`, `publicationID`, `pubPage`, `state`, `url`) VALUES (6114, 2086, 'test2', '2023', 1, '卢三', 1, 1, 2, 1, 73, '1-3', 'adm_pass', '/Users/gongrunze/Rate/upload/个人信息表.pdf');
COMMIT;
...
CREATE TABLE `paper_oper` (
  `ID` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `operatorRole` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '操作人角色',
  `operatorID` int DEFAULT NULL COMMENT '操作人ID',
  `operatorName` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '操作人姓名',
  `paperID` int DEFAULT NULL COMMENT '论文ID',
  `paperName` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '论文名称',
  `pubID` int DEFAULT NULL COMMENT '出版物ID',
  `pubName` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '出版物名称',
  ...
  `state` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '状态',
...
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (216, 'student', 2086, '卢三', 6103, 'test', 3, '《中共党史研究》', '2023-02-28 13:33:48', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (224, 'student', 2086, '卢三', 6109, '2分期刊1', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:04:46', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (225, 'admin', 2, '龚三', 6109, '2分期刊1', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:05:20', '管理员审核通过', 'adm_pass', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (226, 'student', 2086, '卢三', 6110, '2分论文2', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:06:10', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (227, 'admin', 2, '龚三', 6110, '2分论文2', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:06:25', '管理员审核通过', 'adm_pass', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (228, 'student', 2086, '卢三', 6111, '论文1', 18, '《International Conference on Data Engineering(ICDE)》', '2023-03-08 14:31:52', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (229, 'student', 2086, '卢三', 6112, '论文2', 77, '某6分期刊', '2023-03-08 14:34:29', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (230, 'student', 2086, '卢三', 6113, 'test2', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:35:00', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (231, 'student', 2086, '卢三', 6114, 'test2', 73, '《论文认定办法D类某期刊2》', '2023-03-08 14:35:23', '提交论文', 'commit', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (239, 'teacher', 2, '龚三', 6113, 'test2', 72, '《论文认定办法D类某期刊1》', '2023-03-08 14:53:20', '管理员审核通过', 'adm_pass', '');
INSERT INTO `paper_oper` (`ID`, `operatorRole`, `operatorID`, `operatorName`, `paperID`, `paperName`, `pubID`, `pubName`, `time`, `operation`, `state`, `remark`) VALUES (240, 'teacher', 2, '龚三', 6114, 'test2', 73, '《论文认定办法D类某期刊2》', '2023-03-08 14:53:32', '管理员审核通过', 'adm_pass', '');
COMMIT;
...
CREATE TABLE `papercomment` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `underThesisDesignID` int DEFAULT NULL COMMENT '毕业论文或设计的ID',
  `date1` datetime DEFAULT NULL COMMENT '学生的提交的time',
  `date2` datetime DEFAULT NULL COMMENT '老师评价的time',
  `thisWork` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '这次工作完成情况',
  ...
  `whichTime` int DEFAULT NULL COMMENT '在单张表单中是第几次',
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `underThesisDesignID` (`underThesisDesignID`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=667 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of papercomment
-- ----------------------------
BEGIN;
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (1, 1, '2023-01-30 01:05:00', '2023-02-15 00:16:01', '学习vue', '学习elementUI', '好，非常好', 1);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (2, 6, '2023-01-28 08:48:35', '2023-02-19 17:32:49', '1hLDDOwdzW', 'IUYEJxbDTS', 'XkGZjYmv6s', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (3, 4, '2023-01-20 15:20:25', '2023-02-14 01:31:59', 'N7PMojwIic', 'alwsIClpwn', 'mxv9nH91Nk', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (4, 11, '2023-01-07 10:28:57', '2023-02-14 00:19:40', 'q8mpmi8Mht', 'lW9VEY0QvA', 'yAYZDVH8lA', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (5, 6, '2023-01-30 00:45:34', '2023-02-09 08:18:47', '5N50eaOQgA', 'obADKVrtSh', '7rbQDyaAbK', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (6, 6, '2023-01-18 06:20:09', '2023-02-20 16:55:00', 'WK26z4wj9u', 'T1JD4jPR9A', '0hy82J8DHS', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (7, 11, '2023-01-10 00:57:33', '2023-02-18 14:10:59', 'YsDwkWvXoh', 'GRvzODARvL', 'iUxwtc1GBQ', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (8, 1, '2023-01-09 12:21:10', '2023-02-14 19:35:52', '0qNMkRj4De', 'NgVMdvkp67', 'RHreHm9B4j', 2);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (9, 6, '2023-01-17 18:00:27', '2023-02-09 23:42:59', 'j4B67TsVY7', 'QUC6PumvNA', 'FtYOyyqCXR', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (10, 10, '2023-01-19 20:01:05', '2023-02-14 19:09:33', '7AjI0qjV4P', 'dLtMMJgXyw', 'xPbYxsA3J7', NULL);
INSERT INTO `papercomment` (`ID`, `underThesisDesignID`, `date1`, `date2`, `thisWork`, `nextPlan`, `tutorComment`, `whichTime`) VALUES (666, 1, '2023-02-21 14:51:11', '2023-02-22 14:51:18', '好好学习JS', '学习vue', '6', NULL);
COMMIT;
...
CREATE TABLE `participants` (
  ...
  `major` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '本科专业',
...
CREATE TABLE `patentresult` (
  ...
  `rank` int DEFAULT NULL,
  `total` int DEFAULT NULL,
  `rights` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `indicaterID` int NOT NULL,
  `state` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
...
CREATE TABLE `programresult` (
  ...
  `sub` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `head` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `division` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `year` int DEFAULT NULL,
  `way` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
CREATE TABLE `publication` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `abbr` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `publisher` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `url` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (18, '《International Conference on Data Engineering(ICDE)》', NULL, NULL, NULL, NULL, 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (70, '保留', '1', '2', '3', NULL, 5, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (72, '《论文认定办法D类某期刊1》', '1', '2', '3', '4', 25, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (73, '《论文认定办法D类某期刊2》', '1', '2', '3', '4', 25, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (76, '1', '2', '3', '4', NULL, 6, 2023);
INSERT INTO `publication` (`ID`, `name`, `abbr`, `publisher`, `url`, `level`, `indicatorID`, `year`) VALUES (77, '某6分期刊', '3', '4', '5', NULL, 18, 2023);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
INSERT INTO
NULL, 0, 1003, '10', 0);
INSERT INTO `student` (`ID`, `name`, `institutionID`, `studentnumber`, `IDNumber`, `telephone`, `email`, `username`, `password`, `year`, `deleteflag`, `tutorID`, `role`, `score`) VALUES (2097, '卢三old', 1, NULL, '310111111111111111', '13812341231', '123@dhu.edu.cn', 'studentold', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 0, 1003, '10', 0);
INSERT INTO `student` (`ID`, `name`, `institutionID`, `studentnumber`, `IDNumber`, `telephone`, `email`, `username`, `password`, `year`, `deleteflag`, `tutorID`, `role`, `score`) VALUES (2098, '选手test', 1, NULL, '2222776', NULL, NULL, 'participants', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 0, NULL, '12', 0);
COMMIT;
...
CREATE TABLE `teacher` (
  ...
  `institutionID` int DEFAULT NULL COMMENT '外键',
  `name` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `jobnumber` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `sex` varchar(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `department` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `IDNumber` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `phone` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `username` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `password` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `deleteflag` int NOT NULL,
  `role` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '角色',
  PRIMARY KEY (`ID`) USING BTREE,
...
-- ----------------------------
BEGIN;
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (1, 2097, '这是一个本科生的毕业设计或者论文', '2022', 'http://drive.onchu6.info/ArtsHandicraftsSewing');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (2, 2084, 'Fukuda Hana', NULL, 'http://drive.onchu6.info/ArtsHandicraftsSewing');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (3, 2082, 'Steve Ward', NULL, 'http://image.sherrykim.us/Books');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (4, 2084, 'April Turner', NULL, 'http://video.campblucille214.cn/CollectiblesFineArt');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (5, 2075, 'Elizabeth Price', NULL, 'https://video.yuto414.us/ToysGames');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (6, 2092, 'Kikuchi Momoka', NULL, 'http://drive.porternicole.us/ToolsHomeDecoration');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (7, 2097, 'Leung Suk Yee', NULL, 'http://auth.ryotamar.xyz/ToolsHomeDecoration');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (8, 2089, 'Lau Ka Keung', NULL, 'http://image.jonathanro825.info/CDsVinyl');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (9, 2075, 'Maria Coleman', NULL, 'http://drive.kfchoi1002.us/ToolsHomeDecoration');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (10, 2075, 'Shirley Vasquez', NULL, 'https://drive.zeng1947.co.jp/BeautyPersonalCare');
INSERT INTO `underthesisdesign` (`ID`, `studentID`, `name`, `year`, `url`) VALUES (11, 2084, 'Wong Chi Ming', NULL, 'https://drive.mikimur.net/Food');
COMMIT;
