...
INSERT INTO `menu` VALUES (48, '/salary/search/**', '/student/ResearchAward', 'ResearchAward', '科研获奖', NULL, NULL, 1, 69, 1);
...
INSERT INTO `menu` VALUES (69, '/', '/home', 'Home', '成果申报', 'fa-fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (70, '/', '/home', 'Home', '成果列表', 'fa-fa-windows', NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (71, '/', '/home', 'Home', '毕业论文', NULL, NULL, 1, 1, 1);
INSERT INTO `menu` VALUES (72, '/salary/search/**', '/student/PaperCommit', 'PaperCommit', '评审', NULL, NULL, 1, 71, 1);
...
CREATE TABLE `paper`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '论文题目',
...
) ENGINE = InnoDB AUTO_INCREMENT = 6107 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `paper` VALUES (6104, 2086, '段一峰的论文', '2023', 2, '卢三', 1, 1, 12, 3, '1-12', 'commit', 'F:\\rateGit\\upload/L+181310406张怡宁.pdf');
INSERT INTO `paper` VALUES (6105, 2086, '卢三的论文', '2023', 1, NULL, NULL, 2, 12, 2, '1-121', 'commit', 'F:\\rateGit\\upload/TortoiseSVN使用教程.docx');
INSERT INTO `paper` VALUES (6106, 2086, 'Xception: Deep Learning with Depthwise Separable Convolutions', '2023', 2, '卢三', 1, 1, 12, 2, '1-12', 'commit', 'F:\\rateGit\\upload/SqueezeNet.pdf');
...
INSERT INTO `paper_oper` VALUES (214, 'student', 2086, '卢三', 6104, '段一峰的论文', 3, '《中共党史研究》', '2023-02-15 21:09:06', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (215, 'student', 2086, '卢三', 6105, '卢三的论文', 2, '《International Conference on Data Engineering(ICDE)》', '2023-02-15 21:17:31', '提交论文', 'commit', '');
INSERT INTO `paper_oper` VALUES (216, 'student', 2086, '卢三', 6106, 'Depthwise Separable', 2, '《International Conference on Data Engineering(ICDE)》', '2023-02-16 11:20:33', '提交论文', 'commit', '');
...
CREATE TABLE `publication`  (
  ...
  INDEX `name_year`(`year` DESC, `name` ASC) USING BTREE,
...
INSERT INTO `publication` VALUES (17, 'test2022', 'a', 's', 'b', 'c', 18, 2022);
INSERT INTO `publication` VALUES (18, 'test2022.1', 'a', 'b', NULL, NULL, 18, 2022);
...
INSERT INTO `role` VALUES (9, 'ROLE_teacher_2', '研究生导师');
...
) ENGINE = InnoDB AUTO_INCREMENT = 737 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `student` VALUES (2086, '卢三', NULL, NULL, '310111111111111111', '13812341231', '3311980798@qq.com', 'student', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 0, 1003, 11);
...
INSERT INTO `student` VALUES (2097, '卢三old', NULL, NULL, '310111111111111111', '13812341231', '123@dhu.edu.cn', 'studentold', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, 0, 1003, 10);
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (1003, NULL, '张大仙', '1310092', '女', '计算机学院', '310110100000000022', '13800000011', '2222776@mail.dhu.edu.cn', 'teazhang', '$2a$10$uHDCc/t1wijNiOcZZucpbecsV0O61/iKk8mo95w5u43uek1Grz3za', 0, '8');
...
INSERT INTO `teacher` VALUES (1044, NULL, '黄三old', '131025', '男', '计算机学院', '310110100000000010', '13800000010', '010@dhu.edu.cn', 'teacherold', '7c4a8d09ca3762af61e59520943dc26494f8941b', 0, '8;9');
