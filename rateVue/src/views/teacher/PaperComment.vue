            ...
            <el-table
                ...
                <el-table-column align="center" label="已评价" width="100px">
                    <template slot-scope="scope">
                        {{ scope.row.thesis.comment_deny != 0 ? scope.row.thesis.comment_pass+scope.row.thesis.comment_deny + '(' + scope.row.thesis.comment_deny + ')':scope.row.thesis.comment_pass  }}
                    </template>
                </el-table-column>
        ...
        methods: {
            ...
            initEmps() {
                ...
                this.teaID = JSON
                    ...
                    .id;
                const _this = this;
                let url = "/paperComment/basic/getStuThesis?teaID=" + this
                    .teaID
