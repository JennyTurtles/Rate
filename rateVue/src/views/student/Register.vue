  ...
  <div class="box">
    <el-form class="registerContainer" :label-width="labelWidth" :rules="rules">
      ...
      <el-form-item label="确认密码:" prop="confirmPassword">
        ...
        <el-input style="width: 60%" v-model="confirmPassword" type="password" :disabled="!checkPwdState"
...
export default {
  ...
  watch: {
    ...
    //     if (this.confirmPassword.length == this.user.password.length) this.checkPasswordSame()
  ...
  methods: {
    ...
    register() {
      ...
      if (!this.checkPwdState) {
        this.$message.warning('密码必须是8-20位，包含至少一个英文字符，一个数字和一个特殊字符')
        return
      }
